    ...
    constructor(response: any) {
        ...
        if (response && response.status) {
            switch (response.status) {
                ...
                // ****** Information responses ******
                case 100: this.Continue = true; break;
                case 101: this.SwitchingProtocol = true; break;
                case 102: this.Processing = true; break;
                case 103: this.EarlyHints = true; break;

                // ****** Successful responses ******
                case 200: this.OK = true; break;
                case 201: this.Created = true; break;
                case 202: this.Accepted = true; break;
                case 203: this.Non_Authoritative_Information = true; break;
                case 204: this.No_Content = true; break;
                case 205: this.Reset_Content = true; break;
                case 206: this.Partial_Content = true; break;
                case 207: this.Multi_Status = true; break;
                case 208: this.Already_Reported = true; break;
                case 226: this.IM_Used = true; break;

                // ****** Redirectionmessages ******
                case 300: this.Multiple_Choice = true; break;
                case 301: this.Moved_Permanently = true; break;
                case 302: this.Found = true; break;
                case 303: this.See_Other = true; break;
                case 304: this.Not_Modified = true; break;
                case 305: this.Use_Proxy = true; break;
                case 306: this.unused = true; break;
                case 307: this.Temporary_Redirect = true; break;
                case 308: this.Permanent_Redirect = true; break;

                // ****** Client error responses ******
                case 400: this.Bad_Request = true; break;
                case 401: this.Unauthorized = true; break;
                case 402: this.Payment_Required = true; break;
                case 403: this.Forbidden = true; break;
                case 404: this.Not_Found = true; break;
                case 405: this.Method_Not_Allowed = true; break;
                case 406: this.Not_Acceptable = true; break;
                case 407: this.Proxy_Authentication_Required = true; break;
                case 408: this.Request_Timeout = true; break;
                case 409: this.Conflict = true; break;
                case 410: this.Gone = true; break;
                case 411: this.Length_Required = true; break;
                case 412: this.Precondition_Failed = true; break;
                case 413: this.Payload_Too_Large = true; break;
                case 414: this.URI_Too_Long = true; break;
                case 415: this.Unsupported_Media_Type = true; break;
                case 416: this.Requested_Range_Not_Satisfiable = true; break;
                case 417: this.Expectation_Failed = true; break;
                case 421: this.Misdirected_Request = true; break;
                case 422: this.Unprocessable_Entity = true; break;
                case 423: this.Locked = true; break;
                case 424: this.Failed_Dependency = true; break;
                case 425: this.Too_Early = true; break;
                case 426: this.Upgrade_Required = true; break;
                case 428: this.Precondition_Required = true; break;
                case 429: this.Too_Many_Requests = true; break;
                case 431: this.Request_Header_Fields_Too_Large = true; break;
                case 451: this.Unavailable_For_Legal_Reasons = true; break;

                // ****** Server error responses ******
                case 500: this.Internal_Server_Error = true; break;
                case 501: this.Not_Implemented = true; break;
                case 502: this.Bad_Gateway = true; break;
                case 503: this.Service_Unavailable = true; break;
                case 504: this.Gateway_Timeout = true; break;
                case 505: this.HTTP_Version_Not_Supported = true; break;
                case 506: this.Variant_Also_Negotiates = true; break;
                case 507: this.Insufficient_Storage = true; break;
                case 508: this.Loop_Detected = true; break;
                case 510: this.Not_Extended = true; break;
                case 511: this.Network_Authentication_Required = true; break;
            }
        }
    }
